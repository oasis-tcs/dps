...
Persons who are not TC members are invited to open issues and provide comments using this repository's [GitHub Issues](https://github.com/oasis-tcs/dps/issues/new) tracking facility or using the TC's [comment facility](https://groups.oasis-open.org/communities/community-home?CommunityKey=561bfacb-617e-49ff-b426-019e1883be62).  All such content created in GitHub Issues and/or posted to the TC's archived comment list is governed by the terms of the [OASIS Feedback License](https://www.oasis-open.org/policies-guidelines/ipr#appendixa)
