...
The sequence MUST contain at least one organization and all entries MUST be unique for the organization record members — `legal-name`, `address`, and `url` together — not by `legal-name` alone.
